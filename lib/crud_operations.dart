...
class DBHelper {
  ...
  static const String DB_NAME = 'students16.db';
...
//creacion de la base de datos
  ...
  _onCreate(Database db, int version) async {
    await db.execute(
        "CREATE TABLE $TABLE ($Id INTEGER PRIMARY KEY,$photoName BLOB, $NAME TEXT, $SURNAME TEXT, $AM TEXT, $MATRICULA TEXT, $MAIL TEXT, $NUM TEXT )");
  }

  Future<List<Student>> getStudents() async {
    var dbClient = await db;
    List<Map> maps = await dbClient.query(TABLE, columns: [Id,photoName, NAME , SURNAME, AM, MATRICULA, MAIL, NUM ]);
